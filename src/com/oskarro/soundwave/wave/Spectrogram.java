package com.oskarro.soundwave.wave;


import com.oskarro.soundwave.dsp.FastFourierTransform;
import com.oskarro.soundwave.dsp.WindowFunction;
...
public class Spectrogram{
    ...
    private final int fftSampleSize;	// number of sample in fft, the value needed to be a number to power of 2
